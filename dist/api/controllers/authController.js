...
exports.firebaseAuthorization = exports.loginWithFirebaseToken = exports.registerUser = void 0;
...
const loginWithFirebaseToken = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const firebaseToken = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
        if (!firebaseToken) {
            return res.status(400).json({ message: "Firebase token is required" });
        }
        // 🔹 Verify Firebase Token
        const user = yield authService_1.default.verifyFirebaseToken(firebaseToken);
...
const firebaseAuthorization = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const firebaseToken = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
        if (!firebaseToken) {
...
exports.firebaseAuthorization = firebaseAuthorization;
